...
- [nRF_setup](/ZigBee/test/nRF_setup/) folder provides the python file and readme on how to best setup the nRF52840 dongle device if you would like to configure or need to configure the device
